...
<aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 text-white transform -translate-x-full md:translate-x-0 md:static md:inset-0 transition-transform duration-300 ease-in-out flex flex-col h-full border-r border-slate-800">
    ...
    <div class="flex-1 overflow-y-auto py-4">
        <nav class="px-3 space-y-1">
            ...
            <!-- Publications -->
            <a href="publications.php" class="flex items-center px-3 py-2 <?php echo (strpos($current_page, 'publication') !== false) ? 'bg-blue-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-800 hover:text-white'; ?> rounded-lg transition-all group">
                <svg class="w-5 h-5 mr-3 <?php echo (strpos($current_page, 'publication') !== false) ? 'text-white' : 'text-slate-400 group-hover:text-white'; ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                Publications
            </a>
