    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center space-y-8">
            ...
            <p class="text-xl text-platinum-600 max-w-3xl mx-auto leading-relaxed">
                A visual journey through our workshops, events, and projects.
            </p>
            <div class="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 opacity-30">
                <div class="aspect-video bg-platinum-200 rounded-xl"></div>
                <div class="aspect-video bg-platinum-200 rounded-xl"></div>
                <div class="aspect-video bg-platinum-200 rounded-xl"></div>
                <div class="aspect-video bg-platinum-200 rounded-xl"></div>
                <div class="aspect-video bg-platinum-200 rounded-xl"></div>
