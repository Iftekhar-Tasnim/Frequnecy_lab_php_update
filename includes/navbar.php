...
<nav id="navbar" class="fixed top-0 left-0 w-full z-50 transition-all duration-300">
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-prussian-blue-950 border-t border-white/5">
        <div class="px-4 pt-2 pb-6 space-y-1">
            <a href="#/" class="block px-3 py-4 text-white hover:bg-white/5 font-exo mobile-nav-link">Home</a>
            <a href="#/about" class="block px-3 py-4 text-white hover:bg-white/5 font-exo mobile-nav-link">About</a>
            <a href="#/programmes" class="block px-3 py-4 text-white hover:bg-white/5 font-exo mobile-nav-link">Programmes</a>
