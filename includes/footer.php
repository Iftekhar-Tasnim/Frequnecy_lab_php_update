<!-- Footer -->
<footer class="bg-prussian-blue-950 text-white pt-16 pb-12 border-t border-white/5 font-sans">
            ...
            <div class="space-y-8">
                ...
                <ul class="space-y-5">
                    ...
                    <li class="flex items-start gap-4 group">
                        ...
                        <p class="text-platinum-400 text-sm leading-relaxed">Apt:B1, Level:05, Building:Grand 2 Rupayan City, Dhaka</p>
                    </li>
                </ul>
